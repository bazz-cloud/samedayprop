...
export const PLANS: readonly PlanDefinition[] = [
  {
    ...
    drawdownAllowance: proposed(usd('1000.00'), undefined, PROPOSED_RISK),
    dailyLossLimit: proposed(usd('400.00'), undefined, PROPOSED_RISK),
  ...
  },
  {
    ...
    drawdownAllowance: proposed(usd('2000.00'), undefined, PROPOSED_RISK),
    dailyLossLimit: proposed(usd('700.00'), undefined, PROPOSED_RISK),
  ...
  },
  {
    ...
    drawdownAllowance: proposed(usd('3000.00'), undefined, PROPOSED_RISK),
    dailyLossLimit: proposed(usd('1000.00'), undefined, PROPOSED_RISK),
  ...
  },
  {
    ...
    drawdownAllowance: proposed(usd('4500.00'), undefined, PROPOSED_RISK),
    dailyLossLimit: proposed(usd('1500.00'), undefined, PROPOSED_RISK),
  ...
  },
  {
    ...
    drawdownAllowance: proposed(usd('7500.00'), undefined, PROPOSED_RISK),
    dailyLossLimit: proposed(usd('2500.00'), undefined, PROPOSED_RISK),
